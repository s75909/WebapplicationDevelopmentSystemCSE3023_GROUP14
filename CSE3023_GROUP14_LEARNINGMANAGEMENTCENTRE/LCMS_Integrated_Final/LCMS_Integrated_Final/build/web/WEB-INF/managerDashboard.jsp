...
.data-table.bt tr:hover td {
    background: #e3f2fd;
}

.data-table.bt th:last-child,
.data-table.bt td:last-child {
    position: sticky;
    right: 0;
    background: white;
    z-index: 2;
    ...
    <body>
        ...
        <div class="dino-container">
            ...
            <div class="dashboard-grid">
                ...
                <a class="action-card" href="${pageContext.request.contextPath}/registration_1.jsp">
                    <div class="icon">🦕</div>
                    <h3>Add Student</h3>
                ...
                <a class="action-card" href="${pageContext.request.contextPath}/paymentHistory.jsp">
                    <div class="icon">💳</div>
            ...
            <div class="section-wrap orange">
                ...
                <p class="empty-msg">No students registered yet. <a href="${pageContext.request.contextPath}/registration_1.jsp">Add one now →</a></p>
                <% } else { %>
...
<div id="deleteModal"
    ...
    <div style="background:white; border-radius:22px; padding:28px 32px; max-width:380px; width:90%;
        ...
        <h2 style="margin:0 0 10px; color:#b71c1c; font-size:18px;">
            Delete Account
        </h2>
        ...
        <p id="modalName"
           style="font-weight:700; color:#333; font-size:15px; margin:0 0 22px;">
        </p>
...
<script>
    ...
    function executeDelete() {
        if (!_pendingFormId || !_pendingInputId || !_pendingId) {
            alert("Delete failed: missing delete information.");
            return;
        }

        var form = document.getElementById(_pendingFormId);
        var idInput = document.getElementById(_pendingInputId);

        if (!form || !idInput) {
            alert("Delete failed: form not found.");
            return;
        }

        idInput.value = _pendingId;

        /*
         * IMPORTANT:
         * Force form action supaya dia tak pergi ke:
         * /Learn4Lifeweb/WEB-INF/ManagerDashboardServlet
         */
        form.setAttribute("action", "${pageContext.request.contextPath}/ManagerDashboardServlet");
